          ...
          SliverList(delegate: SliverChildListDelegate(
            [
             ...
             child: Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(image: AssetImage("assets/images/images.jpg"),
                    fit: BoxFit.cover)
                  ),
                 child:Column(
             ...
             child: Row(
               ...
               children: [
              const Text("Special for you",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,
               fontSize: 20),),
              ...
              children:[  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(20),
                      image: const DecorationImage(image: AssetImage("assets/images/phone.webp"),
                      fit: BoxFit.fill),
                    ),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
               ...
               const Padding(padding: EdgeInsets.only(left: 10)),
                Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(20),
                      image: const DecorationImage(image: AssetImage("assets/images/fashion.jpg"),
                      fit: BoxFit.fill),
                    ),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
             ...
             child: Row(
               mainAxisAlignment: MainAxisAlignment.spaceBetween,
               children: [
              const Text("Popular Product",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,
               fontSize: 20),),
               TextButton(onPressed: (){}, child: const Text("See More",style: TextStyle(color: Colors.black,fontSize: 15),))]),
               ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(image: AssetImage("assets/images/game.jpg"),
                      fit: BoxFit.fill,)
                    ),
                  ),
                     const Padding(padding: EdgeInsets.only(left: 10)),
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(15),
                      image: const DecorationImage(image: AssetImage("assets/images/shoe.webp"),
                      fit: BoxFit.fill,)
                    ),
                  ),
                     const Padding(padding: EdgeInsets.only(left: 10)),
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(15),
                      image: const DecorationImage(image: AssetImage("assets/images/sports.jpg"),
                      fit: BoxFit.fill,)
                    ),
                  ),
                     const Padding(padding: EdgeInsets.only(left: 10)),
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(15),
                      image: const DecorationImage(image: AssetImage("assets/images/watches.jpg"),
                      fit: BoxFit.fill,)
                    ),
                  ),
